...
# using the Markdown-it library and Pygments
...
def markdown_with_syntax_highlighting(md_input):
    ...
    def custom_fence_renderer(tokens, idx, options, env):
        ...
        # Manejo especial para Mermaid
        if lang.casefold() == "mermaid":
            return f'<div style="text-align: center;"><pre class="mermaid">{code}</pre></div>'
